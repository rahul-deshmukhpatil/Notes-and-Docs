...
- [binary literals](#binary-literals)
	0b1111'1111 == 255, with optional '
- [generic lambda expressions](#generic-lambda-expressions)
	auto type specifier for polymorphic lambda
```c++
...
you can introduce new capture variable, which is private to lambda and intialize it byassigning it return value of function/expression. this will be done at labda definition time and not the time of invocation. this new capture varible is by default constant in nature.
...
```
new reference captures variables can have diff name
```c++
auto x = 1;
auto f = [&r = x, x = x * 10] {
  ++r;
